...
var ttiPolyfill = createCommonjsModule(function(module) {
  (function() {
    ...
    'undefined' != 'object' && module.exports
      ? (module.exports = H)
      : 'function' === typeof undefined && undefined.amd
      ? undefined('ttiPolyfill', [], function() {
          return H;
        })
...
var Performance = /** @class */ (function() {
  ...
  Performance.prototype.performanceObserverCb = function(cb, entryList) {
    ...
    entries.forEach(function(performancePaintTiming) {
      if (
        _this.config.firstContentfulPaint &&
...
var Perfume = /** @class */ (function() {
  ...
  Perfume.prototype.firstContentfulPaintCb = function(entries) {
    ...
    entries.forEach(function(performancePaintTiming) {
      if (_this.config.firstPaint && performancePaintTiming.name === 'first-paint') {
    ...
    if (
      ...
      this.perf.timeToInteractive(
        firstContentfulPaintDuration,
        this.timeToInteractiveCb.bind(this)
      );
    }
  };
  /**
