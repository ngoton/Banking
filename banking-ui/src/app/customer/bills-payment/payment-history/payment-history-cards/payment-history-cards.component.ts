...
@Component({
  selector: 'app-payment-history-cards',
...
export class PaymentHistoryCardsComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // this.billsPaymentService.paymentHistory$.pipe(untilDestroyed(this))
    //   .subscribe(bills => {
    ...
    //     this.loading = false;
    //   });
    // this.billsPaymentService.paymentHistoryError$.pipe(untilDestroyed(this))
    //   .subscribe(err => {
    //     this.message = err;
    //     this.loading = false;
    //   });
